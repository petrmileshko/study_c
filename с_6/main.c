...
int main(void)
{
    ...
    // элементы с 1 по 49 будут хранить количество слов, длины которых соответствуют индексу элемента 
    // 0 элемент не задействован, так как слов с нулевой длинной нет
