...
## Настройка среды для сборки
 ...
 3. Обновить пакетный менеджер и базовые пакеты. После установки запустить терминал MSYS2 и выполнить команду: pacman -Su
 4. Установить компилятор. В терминале MSYS2 выполнить команду: pacman -S mingw-w64-ucrt-x86_64-gcc
 5. Установить сборщик Make. В терминале MSYS2 выполнить команду: pacman -S make
